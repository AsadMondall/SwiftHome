...
class _PlumberPageState extends State<PlumberPage> {
  ...
  List<dynamic> _tasks = [
    [
      'Pipe Fixing',
      'https://img.icons8.com/fluency/2x/pipe.png',
      Colors.red,
      0
    ],
    [
      'Leak Repair',
      'https://img.icons8.com/fluency/2x/leak.png',
      Colors.orange,
      1
    ],
    [
      'Drain Cleaning',
      'https://img.icons8.com/fluency/2x/drain.png',
      Colors.blue,
      1
    ],
    [
      'Water Heater Installation',
      'https://img.icons8.com/fluency/2x/water-heater.png',
      Colors.purple,
      0
    ],
    [
      'Toilet Repair',
      'https://img.icons8.com/fluency/2x/toilet.png',
      Colors.green,
      0
    ]
  ];

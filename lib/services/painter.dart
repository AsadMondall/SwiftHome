...
class _PainterPageState extends State<PainterPage> {
  ...
  List<dynamic> _tasks = [
    [
      'Interior Painting',
      'https://img.icons8.com/fluency/2x/paint-roller.png',
      Colors.blue,
      0
    ],
    [
      'Exterior Painting',
      'https://img.icons8.com/fluency/2x/paint.png',
      Colors.orange,
      1
    ],
    [
      'Wallpaper Installation',
      'https://img.icons8.com/fluency/2x/wallpaper.png',
      Colors.green,
      1
    ],
    [
      'Staining & Varnishing',
      'https://img.icons8.com/fluency/2x/varnish.png',
      Colors.purple,
      0
    ],
    [
      'Touch-ups',
      'https://img.icons8.com/fluency/2x/touch-up.png',
      Colors.red,
      0
    ]
  ];
            ...
            SliverToBoxAdapter(
              child: FadeAnimation(
                ...
                Padding(
                  ...
                  child: Text(
                    'What painting service do you need?',
                    style: TextStyle(
                      fontSize: 24,

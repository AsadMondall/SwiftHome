...
class _CookPageState extends State<CookPage> {
  ...
  List<dynamic> _tasks = [
    [
      'Meal Preparation',
      'https://img.icons8.com/fluency/2x/meal.png',
      Colors.red,
      0
    ],
    [
      'Baking',
      'https://img.icons8.com/fluency/2x/baking.png',
      Colors.orange,
      1
    ],
    [
      'Catering',
      'https://img.icons8.com/fluency/2x/catering.png',
      Colors.blue,
      1
    ],
    [
      'Special Diet',
      'https://img.icons8.com/fluency/2x/diet.png',
      Colors.purple,
      0
    ],
    [
      'Cooking Class',
      'https://img.icons8.com/fluency/2x/cooking-class.png',
      Colors.green,
      0
    ]
  ];
            ...
            SliverToBoxAdapter(
              child: FadeAnimation(
                ...
                Padding(
                  ...
                  child: Text(
                    'What cooking service do you need?',
                    style: TextStyle(
                      fontSize: 24,

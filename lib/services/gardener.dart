...
class GardenerPage extends StatefulWidget {
  const GardenerPage({Key? key}) : super(key: key);

  @override
  _GardenerPageState createState() => _GardenerPageState();
}
...
class _GardenerPageState extends State<GardenerPage> {
  ...
  List<dynamic> _tasks = [
    [
      'Lawn Mowing',
      'https://img.icons8.com/fluency/2x/lawn-mower.png',
      Colors.green,
      0
    ],
    [
      'Weeding',
      'https://img.icons8.com/fluency/2x/weeding.png',
      Colors.orange,
      1
    ],
    [
      'Pruning',
      'https://img.icons8.com/fluency/2x/pruning.png',
      Colors.blue,
      1
    ],
    [
      'Planting',
      'https://img.icons8.com/fluency/2x/planting.png',
      Colors.purple,
      0
    ],
    [
      'Garden Design',
      'https://img.icons8.com/fluency/2x/garden.png',
      Colors.red,
      0
    ]
  ];
            ...
            SliverToBoxAdapter(
              child: FadeAnimation(
                ...
                Padding(
                  ...
                  child: Text(
                    'What gardening service do you need?',
                    style: TextStyle(
                      fontSize: 24,

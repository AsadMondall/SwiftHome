...
class _TailorPageState extends State<TailorPage> {
  ...
  List<dynamic> _tasks = [
    [
      'Alterations',
      'https://img.icons8.com/fluency/2x/scissors.png',
      Colors.red,
      0
    ],
    [
      'Custom Tailoring',
      'https://img.icons8.com/fluency/2x/tailoring.png',
      Colors.orange,
      1
    ],
    ['Repairs', 'https://img.icons8.com/fluency/2x/repair.png', Colors.blue, 1],
    [
      'Embroidery',
      'https://img.icons8.com/fluency/2x/embroidery.png',
      Colors.purple,
      0
    ],
    [
      'Fittings',
      'https://img.icons8.com/fluency/2x/fitting.png',
      Colors.green,
      0
    ]
  ];
            ...
            SliverToBoxAdapter(
              child: FadeAnimation(
                ...
                Padding(
                  ...
                  child: Text(
                    'What tailoring service do you need?',
                    style: TextStyle(
                      fontSize: 24,

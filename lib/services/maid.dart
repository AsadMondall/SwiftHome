...
class HandymanPage extends StatefulWidget {
  const HandymanPage({Key? key}) : super(key: key);

  @override
  _HandymanPageState createState() => _HandymanPageState();
}
...
class _HandymanPageState extends State<HandymanPage> {
  ...
  List<dynamic> _tasks = [
    [
      'Plumbing',
      'https://img.icons8.com/fluency/2x/plumbing.png',
      Colors.blue,
      0
    ],
    [
      'Electrical',
      'https://img.icons8.com/fluency/2x/electrical.png',
      Colors.orange,
      1
    ],
    [
      'Carpentry',
      'https://img.icons8.com/fluency/2x/carpentry.png',
      Colors.brown,
      1
    ],
    [
      'Painting',
      'https://img.icons8.com/fluency/2x/painting.png',
      Colors.purple,
      0
    ],
    [
      'General Repair',
      'https://img.icons8.com/fluency/2x/repair.png',
      Colors.red,
      0
    ]
  ];

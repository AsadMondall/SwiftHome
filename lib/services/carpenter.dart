...
class _CarpenterPageState extends State<CarpenterPage> {
  ...
  List<dynamic> _tasks = [
    [
      'Furniture Repair',
      'https://img.icons8.com/fluency/2x/furniture.png',
      Colors.brown,
      0
    ],
    [
      'Woodwork',
      'https://img.icons8.com/fluency/2x/wood.png',
      Colors.orange,
      1
    ],
    [
      'Cabinet Installation',
      'https://img.icons8.com/fluency/2x/cabinet.png',
      Colors.blue,
      1
    ],
    [
      'Door Repair',
      'https://img.icons8.com/fluency/2x/door.png',
      Colors.purple,
      0
    ],
    ['Flooring', 'https://img.icons8.com/fluency/2x/floor.png', Colors.green, 0]
  ];
            ...
            SliverToBoxAdapter(
              child: FadeAnimation(
                ...
                Padding(
                  ...
                  child: Text(
                    'What carpentry service do you need?',
                    style: TextStyle(
                      fontSize: 24,

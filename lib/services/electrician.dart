...
class _ElectricianPageState extends State<ElectricianPage> {
  // Electrical tasks
  List<dynamic> _tasks = [
    ['Wiring', 'https://img.icons8.com/fluency/2x/wiring.png', Colors.red, 0],
    [
      'Light Installation',
      'https://img.icons8.com/fluency/2x/light.png',
      Colors.orange,
      1
    ],
    [
      'Switch Repair',
      'https://img.icons8.com/fluency/2x/switch.png',
      Colors.blue,
      1
    ],
    [
      'Circuit Breaker Repair',
      'https://img.icons8.com/fluency/2x/circuit.png',
      Colors.purple,
      0
    ],
    [
